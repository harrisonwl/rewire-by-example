...
{-
verilator -cc Inc3.sv
verilator -cc Inc3.sv
%Warning-WIDTHEXPAND: Inc3.sv:35:39: Operator ASSIGNW expects 17 bits on the Assign RHS, but Assign RHS's REPLICATE generates 16 bits.
                                   : ... note: In instance 'top_level'
   35 |   assign {__continue, __out0, __out1} = {binop_inR5[15:8] << binop_inR5[7:0], binop_inR7[15:8] ^ binop_inR7[7:0]};
      |                                       ^
                      ... For warning description see https://verilator.org/warn/WIDTHEXPAND?v=5.030
