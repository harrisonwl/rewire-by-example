{-# LANGUAGE DataKinds #-}
module EX_TX_UART where

import Prelude hiding ((-) , (<) , (+))
import ReWire hiding (signal , lift , get , put)
import ReWire.Bits
...
-- :t re_inf (loop i0) (i0 , rf0 , (False , False))
-- re_inf (loop i0) (i0 , rf0 , (False , False))
--   :: Stream I -> Stream (I, RF, (Bit, Bit))
